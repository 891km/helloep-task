...
export default function FilterReset({ postCount }) {
  ...
  return (
    <div className="flex-1 flex justify-between items-center border-b border-b-gray">
      <span className="text-gray text-sm">{postCount} results</span>

      <button
        className="text-foreground flex justify-between items-center gap-1"
